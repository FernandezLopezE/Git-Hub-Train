...
window.location="../view_solicitudes_cliente.jsp";
        </script>             
        <%
        } else {
...
// VALIDAR INVENTARIO MISMAS HORAS
            ...
            for (int i = 0; i < id_m.length; i++) {
                ...
                contador = d.validarInv(id_m[t], cantidad[i], fecha, horaIni, horaFin);
                suma = suma + contador;
                t++;
            }
            if (suma >= 100) {
...
//------------------------------------------------------------------
        ...
        <%
            ...
            for (int j = 0; j < id_m.length; j++) {
                ...
                if (cantidad[f] == null || cantidad[j] == "" || cantidad[j].isEmpty()) {
                    //                            out.print("vacio <br>");
                } else {

                    contador = d.validarFN(id_m[f], cantidad[j]);
                    suma = suma + contador;
                    f++;
                }
            }
